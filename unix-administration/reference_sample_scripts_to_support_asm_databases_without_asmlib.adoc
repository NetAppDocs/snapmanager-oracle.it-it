...
summary: Gli script di esempio sono disponibili nella directory plugins/emesemes/noasmlib della directory di installazione di SnapManager per Oracle. 
---
= Script di esempio per supportare database ASM senza ASMLib
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Gli script di esempio sono disponibili nella directory plugins/emesemes/noasmlib della directory di installazione di SnapManager per Oracle.
